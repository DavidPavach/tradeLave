    ...
    return (
        <section className="py-24">
            <div className="mx-auto px-4 md:px-6 xl:px-8 max-w-4xl text-center">
                <div className="bg-card/70 shadow-sm backdrop-blur px-4 md:px-6 lg:px-8 xl:px-10 py-14 border border-border/70 rounded-[2rem]">
                    <h2 className="font-semibold text-foreground text-2xl md:text-3xl xl:text-4xl tracking-[-0.03em]">
                        Start trading with more confidence.
                    </h2>
                    <p className="mx-auto mt-4 max-w-2xl text-muted-foreground text-base leading-8">
                        Open your account with a product experience that puts transparency, security, and operational clarity first.
                    </p>
